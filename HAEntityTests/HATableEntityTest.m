...
- (void)setUp
{
    ...
    [[HAEntityManager instanceForPath:dbFilePath] addEntityMigrating:migration];
    [[HAEntityManager instanceForPath:dbFilePath] addEntityMigrating:migration2];
    [[HAEntityManager instanceForPath:dbFilePath] upToHighestVersion];
}
